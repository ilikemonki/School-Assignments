...
# Find Conditional Probability P(S = 1 | R = 1), i.e. the prob. that if R = 1, it came from S = 1.
# P(S=1 | R=1) = Success / Number of R = 1
...
probSuccess = success / sum(R)    # Get the probability that if R = 1, it will be successful.
print("Probability of P(S = 1 | R = 1): " + str(probSuccess))
